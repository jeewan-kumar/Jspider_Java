...
public class Rotate120Left {
    public static void main(String[] args) {
        ...
        int[][] rotatedMatrix = rotate120Left(matrix);

        // Display the rotated matrix
        System.out.println("Matrix after 120-degree Left Rotation:");
    ...
    // Method to rotate a matrix 120 degrees to the left
    private static int[][] rotate120Left(int[][] matrix) {
